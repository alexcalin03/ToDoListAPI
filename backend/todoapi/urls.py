...
from .views import project_list, todo_list, register_user,logout_user, user_projects, user_todos, create_project, create_todo, delete_project, delete_todo,update_project, update_todo,send_notification, respond_to_todo_notification, get_notifications,mark_informational_as_responded,mark_all_as_cleared,update_password,get_user_details
...
urlpatterns = [
    ...
    path('mark_all_as_cleared/', mark_all_as_cleared, name='mark_all_as_cleared'),
